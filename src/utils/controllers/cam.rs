...
impl<'a> CameraSensor<'a> {
    pub fn init_status(&self) -> Result<(), u32> {
    ...
    pub fn set_xclk(&self, timer: i32, xclk: i32) -> Result<(), u32> {
...
impl<'a> Camera<'a> {
    pub fn new(
        ...
        let config = camera::camera_config_t {
            ...
            ledc_timer: esp_hal::ledc::timer::Number::Timer0,
            ledc_channel: esp_hal::ledc::channel::Number::Channel0,
